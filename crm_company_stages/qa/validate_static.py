...
reviewed upstream 18.0 views. They are not a copy of a live combined view.
...
FIXTURES = {
    ...
    "crm.crm_stage_tree": """<list multi_edit="1"><field name="sequence"/><field name="name"/>
        <field name="is_won"/><field name="team_id"/><field name="rotting_threshold_days"/></list>""",
...
def main():
    ...
    assert manifest["version"] == "18.0.1.0.0"
